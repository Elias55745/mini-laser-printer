...
The printer comes with the firmware pre-installed; re-flashing is not required. To make changes, modify the code in the repository and re-flash the ATmega328 main controller. If you don't need to customize the firmware, simply ignore this notice.
